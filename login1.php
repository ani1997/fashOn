...
if(isset($_POST['signIn']))
{
	...
	{
		$d=mysqli_query($con,"SELECT * FROM userinfo where username='{$_POST['username']}'");
		$row=mysqli_fetch_object($d);
		$fname=$row->username;
		$fpass=$row->password;
		if($fname==$_POST['username'] && $fpass==$_POST['password'])
		{
			$_SESSION['sname']=$_POST['username'];
			header('location:bistro.html');
		}
		else
		{
...
<head>
	...
	<title>Bistro | The Family Restaurant</title>
            ...
            <form action="login1.php" method="post">
                ...
                <table style="margin-top: 50px;" align="center">
                	...
                	<tr>
                		...
                		<th colspan="2" style="color: red; font-family: 'Josefin Sans', cursive; text-align: right; font-size: 18px;">Invalid Username or Password</th>
            ...
            <form action="signup.php" method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td width="250px"><input class="form-control input-lg" type="text" placeholder="Enter Name" name="username"></td>
                    ...
                    <tr>
                        ...
                        <td width="250px"><input class="form-control input-lg" type="password" placeholder="Enter Password" name="password"></td>
                    ...
                    <tr>
                        ...
                        <td width="250px"><input class="form-control input-lg" type="email" placeholder="Enter Email" name="email"></td>
